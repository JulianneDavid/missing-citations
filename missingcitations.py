...
#             jaccards[paper] = len(ref_overlap) / len(union)
#
#     itemsi = intersections.iteritems()
#     itemsj = jaccards.iteritems()
#
#     largest_intersectionsi = sorted(itemsi, key=itemgetter(1), reverse=True)[:n]
#
#     for pmid in largest_intersectionsi:
#         matchesi.append(pmid[0])
#         for ref in cite_dict[pmid[0]]:
#             if ref not in missing_citationsi:
#                 missing_citationsi.append(ref)
#
#     largest_intersectionsj = sorted(itemsj, key=itemgetter(1), reverse=True)[:n]
#
#     for pmid in largest_intersectionsj:
#         matchesj.append(pmid[0])
#         for ref in cite_dict[pmid[0]]:
#             if ref not in missing_citationsj:
#                 missing_citationsj.append(ref)
#
#     print("intersections:")
#     print(matchesi)
#
#     print("Papers cited by these that are not cited by paper X are:")
#     print(missing_citationsi)
#
#     print("Jaccards:")
#     print(matchesj)
#
